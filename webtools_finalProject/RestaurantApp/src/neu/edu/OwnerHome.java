...
public class OwnerHome {
	...
	public Owner merge(Owner detachedInstance) {
		...
		try {
			Owner result = (Owner) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Owner findById(int id) {
		...
		try {
			Owner instance = (Owner) sessionFactory.getCurrentSession().get("neu.edu.Owner", id);
			if (instance == null) {
	...
	public List<Owner> findByExample(Owner instance) {
		...
		try {
			List<Owner> results = (List<Owner>) sessionFactory.getCurrentSession().createCriteria("neu.edu.Owner")
