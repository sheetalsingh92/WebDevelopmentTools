...
public class CustomerHome {
	...
	public Customer findById(int id) {
		...
		try {
			Customer instance = (Customer) sessionFactory.getCurrentSession().get("neu.edu.Customer", id);
			if (instance == null) {
	...
	public List<Customer> findByExample(Customer instance) {
		...
		try {
			List<Customer> results = (List<Customer>) sessionFactory.getCurrentSession()
					.createCriteria("neu.edu.Customer").add(create(instance)).list();
