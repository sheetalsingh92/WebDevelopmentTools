...
public class AdminHome {
	...
	public Admin findById(int id) {
		...
		try {
			Admin instance = (Admin) sessionFactory.getCurrentSession().get("neu.edu.Admin", id);
			if (instance == null) {
	...
	public List<Admin> findByExample(Admin instance) {
		...
		try {
			List<Admin> results = (List<Admin>) sessionFactory.getCurrentSession().createCriteria("neu.edu.Admin")
