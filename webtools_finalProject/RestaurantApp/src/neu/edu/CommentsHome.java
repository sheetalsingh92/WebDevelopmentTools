...
public class CommentsHome {
	...
	public Comments findById(java.lang.Integer id) {
		...
		try {
			Comments instance = (Comments) sessionFactory.getCurrentSession().get("neu.edu.Comments", id);
			if (instance == null) {
	...
	public List<Comments> findByExample(Comments instance) {
		...
		try {
			List<Comments> results = (List<Comments>) sessionFactory.getCurrentSession()
					.createCriteria("neu.edu.Comments").add(create(instance)).list();
