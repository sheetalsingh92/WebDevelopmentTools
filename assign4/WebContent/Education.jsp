...
<input type="text" class="form-control" name="education" id="education" placeholder="Masters at NEU.." value="${r1.education}" required/><br/>
<select id="gpa" class="form-control" name="gpa" value="${resume.gpa}" >
